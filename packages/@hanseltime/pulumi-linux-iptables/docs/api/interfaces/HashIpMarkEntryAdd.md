...
[@hanseltime/pulumi-linux-iptables](../README.md) / HashIpMarkEntryAdd

# Interface: HashIpMarkEntryAdd

If skbinfo is enable for the ipset

## Extends

- [`HashIpMarkEntry`](HashIpMarkEntry.md).[`CommonEntryOptions`](CommonEntryOptions.md)
...
[`HashIpMarkEntry`](HashIpMarkEntry.md).[`ip`](HashIpMarkEntry.md#ip)
...
[`HashIpMarkEntry`](HashIpMarkEntry.md).[`mark`](HashIpMarkEntry.md#mark)
