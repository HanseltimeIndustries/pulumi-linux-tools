...
[@hanseltime/pulumi-linux-iptables](../README.md) / BitMapIpEntryAdd

# Interface: BitMapIpEntryAdd

If skbinfo is enable for the ipset

## Extends

- [`CommonEntryOptions`](CommonEntryOptions.md).[`BitMapIpEntry`](BitMapIpEntry.md)
...
[`BitMapIpEntry`](BitMapIpEntry.md).[`ip`](BitMapIpEntry.md#ip)
