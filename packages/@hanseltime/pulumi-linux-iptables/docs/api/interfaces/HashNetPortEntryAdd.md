...
[@hanseltime/pulumi-linux-iptables](../README.md) / HashNetPortEntryAdd

# Interface: HashNetPortEntryAdd

If skbinfo is enable for the ipset

## Extends

- [`HashNetPortEntry`](HashNetPortEntry.md).[`CommonEntryOptions`](CommonEntryOptions.md)
...
[`HashNetPortEntry`](HashNetPortEntry.md).[`netaddr`](HashNetPortEntry.md#netaddr)
...
[`HashNetPortEntry`](HashNetPortEntry.md).[`port`](HashNetPortEntry.md#port)
...
[`HashNetPortEntry`](HashNetPortEntry.md).[`protocol`](HashNetPortEntry.md#protocol)
